...
addOptional(p,'dot_size',5/sqrt(length(x)),validScalarPosNum)
...
addOptional(p,'MarkerFaceAlpha',.4)
addOptional(p,'MarkerEdgeColor','none')
parse(p,x,y,varargin{:});

% extra parameters
rwid = 0.05; % width of overlay box/dash

dcut=1; % spacing factor
nxloc=2000; % resolution for optimization
chanwid = 30; % percent width of channel to use
